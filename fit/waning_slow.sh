...
#SBATCH --job-name=waning_slow              # Job name
...
#SBATCH --output=waning_slow.%j.out          # Standard output log
#SBATCH --error=waning_slow.%j.err          # Standard error log          
