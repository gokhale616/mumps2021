...
#SBATCH --job-name=leaky2_2_rapid              # Job name
...
#SBATCH --output=leaky2_2_rapid.%j.out          # Standard output log
#SBATCH --error=leaky2_2_rapid.%j.err          # Standard error log          
