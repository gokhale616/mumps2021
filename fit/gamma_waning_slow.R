...
mle_gamma_waning_slow_is <- DE_traj_match(covar = mod_mumps_covariates_slow, 
                                          waning_distribution = "gamma",
                                          param_constraints = param_range_waning, 
                                          params = param_vals_est, 
                                          ode_control = list(method = "ode23"),
                                          hypo_name = "gwaning_slow", 
                                          best_past_est = gg_waning_slow, 
                                          incidence_data = in_sample_mumps_case_reports)



save(mle_gamma_waning_slow_is, file = "../result_data/mle/mle_gamma_waning_slow_is.rds")
