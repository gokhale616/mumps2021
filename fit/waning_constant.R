...
mle_waning_constant_is <- DE_traj_match(covar = mod_mumps_covariates_constant, 
                                        param_constraints = param_range_waning, 
                                        params = param_vals_est, 
                                        ode_control = list(method = "ode23"),
                                        hypo_name = "noloss_constant", 
                                        best_past_est = gg_waning_constant, 
                                        incidence_data = in_sample_mumps_case_reports)



save(mle_waning_constant_is, file = "../result_data/mle/mle_waning_consant_is.rds")
