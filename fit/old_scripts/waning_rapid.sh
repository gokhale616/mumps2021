...
#SBATCH --job-name=waning_rapid              # Job name
...
#SBATCH --output=waning_rapid.%j.out          # Standard output log
#SBATCH --error=waning_rapid.%j.err          # Standard error log          
