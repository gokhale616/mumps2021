...
#SBATCH --job-name=leaky2_2_slow              # Job name
...
#SBATCH --output=leaky2_2_slow.%j.out          # Standard output log
#SBATCH --error=leaky2_2_slow.%j.err          # Standard error log          
