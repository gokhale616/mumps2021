...
#SBATCH --job-name=waning_sigmoid              # Job name
...
#SBATCH --output=waning_sigmoid.%j.out          # Standard output log
#SBATCH --error=waning_sigmoid.%j.err          # Standard error log          
