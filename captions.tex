...
\textbf{Vaccine efficacy through time.} Temporal dynamics in the relative risk of infections post vaccination corresponding to [0,5) and [5,15) year age-cohorts (facet rows); With or without a booster vaccine schedule (facet columns); And across changing values of immune duration (colours). Relative-risk at the estimated MLE of the vaccine derived immune duration (indigo)}
