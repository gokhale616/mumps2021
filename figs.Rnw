...
<<inc_data_plot, warning = FALSE, echo = FALSE, fig.cap = '\\capInc', out.width = outwidth[2]>>=

plot(incidence_age_geog)

@

<<fit_table,  results = "asis", warning = FALSE, echo=FALSE, out.width = outwidth[1], out.extra = ''>>=
...
<<fit_plot, warning = FALSE, echo = FALSE, fig.cap = '\\capFitplot', out.width = outwidth[2]>>=

plot(fit_plot_grid)

@

<<KLdiv_plot, warning = FALSE, echo = FALSE, fig.cap = '\\capKLdiv', out.width = outwidth[2]>>=
...
<<summary_plot, warning = FALSE, echo = FALSE, fig.cap = '\\capSumplot', out.width = outwidth[3]>>=

plot(epi_summary_plt)

@

<<vacc_RR_plot, warning = FALSE, echo = FALSE, fig.cap = '\\capVaccEffplot', out.width = outwidth[2]>>=
